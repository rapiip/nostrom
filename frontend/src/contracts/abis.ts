...
/** From artifacts/contracts/NostromFactory.sol/NostromFactory.json */
export const nostromFactoryAbi = [
  {
    "inputs": [],
    ...
    "outputs": [
      {
        ...
        "internalType": "struct NostromFactory.VaultSnapshot",
        "name": "snapshot",
        "type": "tuple"
      }
    ],
...
/** From artifacts/contracts/NostromFactory.sol/NostromVault.json */
export const nostromVaultAbi = [
  {
    "inputs": [],
    "stateMutability": "nonpayable",
    "type": "constructor"
...
/** From artifacts/contracts/test/MockERC20.sol/MockERC20.json */
